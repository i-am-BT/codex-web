...
test('Meter detail has six reference cards, visible daily totals and working export controls',async()=>{
  ...
  const api=new Function('document','refreshIcons','setIconLabel','syncCodexAppCredits','URL','Blob','setTimeout',code+';return {renderCodexMeter,codexMeterCompact,exportCodexMeter};')(
